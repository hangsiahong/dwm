...
/* static char selbordercolor[] = "#435FB8"; */
static char selbordercolor[] = "#171717";
static char selbgcolor[] = "#040405";
...
const char *spcmd2[] = {TERMINAL, "-n",	   "spcalc", "-f", "InterBold:size=16",
			"-g",	  "50x20", "-e",     "bc", "-lq",
			NULL};
...
static Key keys[] = {
    ...
    {MODKEY, XK_v, spawn, SHCMD("sh ~/screenshot.sh partial clipboard")},
    {MODKEY, XK_c, spawn, SHCMD("sh ~/screenshot.sh current clipboard")},
